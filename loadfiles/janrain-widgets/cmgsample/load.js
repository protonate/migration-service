(function() {
    ...
    if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = 'https://cmg-dev.rpxnow.com';
    ...
    if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = 'nlhkaabgfmcjjajgdhdj';
    if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = 'https://cmg-dev.rpxnow.com';
    ...
    if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = 'https://cmg-dev.rpxnow.com';
...
function _loadDynamicScript(src, callback) {
    ...
    url += '/cmgsample/janrain-capture.js';
    e.src = url;
