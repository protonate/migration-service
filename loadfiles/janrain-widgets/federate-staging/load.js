(function() {
	...
	if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = 'https://fox-news-dev.rpxnow.com';
    ...
    if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = 'https://fox-news-dev.rpxnow.com';
    ...
    if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = 'https://fox-news-dev.rpxnow.com';
...
function _loadDynamicScript(src, callback) {
    ...
    function getPackagePath(packages) {
        ...
        var path = rootPath + 'federate-staging/' + packages.join('-') + '.js';
        return path;
    }
