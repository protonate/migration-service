(function() {
	...
	if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = 'https://capturewidget.rpxnow.com';
    ...
    if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = 'fdkkiigmobpeegphcnbc';
    if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = 'https://capturewidget.rpxnow.com';
    janrain.settings.permissions = ["customizable_auth_widget_hide_attribution","customizable_auth_widget_styling"];
    if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["aol","google","yahoo","openid"];
    ...
    if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = 'https://capturewidget.rpxnow.com';
...
*  @private
*/
function _scriptLoader(a,b){function h(a){d=!0;"undefined"!==typeof e&&clearTimeout(e);if("string"===typeof a)return"function"===typeof f&&f(a),!0;if("object"===typeof a||"undefined"===typeof a)return"function"===typeof g&&g(),!0}function i(){j++;if(d)return!0;200>j?e=setTimeout(i,50):h("Load Timeout Error")}var g=b,f,j=0,e,c=document.createElement("script"),k=document.getElementsByTagName("script")[0],d=!1;c.src=a;c.setAttribute("type","text/javascript");c.onload=c.onerror=c.onreadystatechange=function(a){!d&&
(!this.readyState||"loaded"===this.readyState||"complete"===this.readyState)&&h(a)};return{setTimeoutCallback:function(a){f=a;return this},setCallback:function(a){g=a;return this},setTimeoutLimit:function(){return this},load:function(){k.parentNode.insertBefore(c,k);i()}}}function _loadDynamicScript(a,b){_scriptLoader(a,b).load()}
function getPackagePath(a){return("https:"===document.location.protocol?"https://d16s8pqtk4uodx.cloudfront.net/":"http://d16s8pqtk4uodx.cloudfront.net/")+"manifest-development/"+a.join("-")+".js"}function getTranslationPath(a,b){return("https:"===document.location.protocol?"https://d29usylhdk1xyu.cloudfront.net/":"http://widget-cdn.rpxnow.com/")+"translations/"+b+"/"+a}
