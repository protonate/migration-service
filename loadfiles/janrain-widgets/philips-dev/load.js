(function() {
	...
	if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = 'https://philips-dev.rpxnow.com';
    ...
    if (typeof janrain.settings.width === 'undefined')janrain.settings.width = '162';
    if (typeof janrain.settings.providersPerPage === 'undefined')janrain.settings.providersPerPage = '4';
    if (typeof janrain.settings.actionText === 'undefined')janrain.settings.actionText = ' Login with your social account';
    if (typeof janrain.settings.fontColor === 'undefined')janrain.settings.fontColor = '#965151';
    ...
    if (typeof janrain.settings.buttonBorderColor === 'undefined')janrain.settings.buttonBorderColor = '#ffffff';
    if (typeof janrain.settings.buttonBorderRadius === 'undefined')janrain.settings.buttonBorderRadius = '0';
    ...
    if (typeof janrain.settings.borderColor === 'undefined')janrain.settings.borderColor = '#ffffff';
    if (typeof janrain.settings.borderRadius === 'undefined')janrain.settings.borderRadius = '0';
    if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = 'bdbppnbjfcibijknnfkk';
    if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = 'https://philips-dev.rpxnow.com';
    ...
    if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = 'https://philips-dev.rpxnow.com';
