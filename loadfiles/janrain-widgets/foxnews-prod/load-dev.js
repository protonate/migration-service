(function() {
	...
	if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = 'https://login-foxnews.rpxnow.com';
    ...
    if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = 'adkgcommiifaielbjbpa';
    if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = 'https://login-foxnews.rpxnow.com';
    ...
    if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = 'https://login-foxnews.rpxnow.com';
