(function() {
	...
	if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = 'https://vtest2.rpxnow.com';
    ...
    if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = 'mlfeingbenjalleljkpo';
    if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = 'https://vtest2.rpxnow.com';
    ...
    if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = 'https://vtest2.rpxnow.com';
