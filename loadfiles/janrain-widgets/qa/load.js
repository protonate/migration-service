(function() {
    ...
    if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = 'https://qa-auto-capture-widget.rpxnow.com';
    ...
    if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = 'omhallnpdcjhiaeegbdd';
    if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = 'https://qa-auto-capture-widget.rpxnow.com';
    ...
    if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = 'https://qa-auto-capture-widget.rpxnow.com';
