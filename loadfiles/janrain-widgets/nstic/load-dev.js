(function() {
    ...
    if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = 'https://nstic-dev.rpxnow.com';
    ...
    if (typeof janrain.settings.width === 'undefined')janrain.settings.width = '182';
    if (typeof janrain.settings.providersPerPage === 'undefined')janrain.settings.providersPerPage = '5';
    if (typeof janrain.settings.actionText === 'undefined')janrain.settings.actionText = 'Sign in with NSTIC';
    ...
    if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = 'aeobkpkdcbhfblbkkiik';
    if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = 'https://nstic-dev.rpxnow.com';
    janrain.settings.permissions = ["customizable_auth_widget_hide_attribution","customizable_auth_widget_styling"];
    if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["openid"];
    ...
    if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = 'https://nstic-dev.rpxnow.com';
