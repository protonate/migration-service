var http = require('http'),
    ...
    hosts = {
        ...
        s3 : {
            hostname : 'd16s8pqtk4uodx.cloudfront.net',
            ...
            for(var i = 0, len = data.Contents.length; i < len; i++) {
                ...
                if(parts[1] && parts[1].match(/load.js/)) {
                    RPs.push({
                        "rp": parts[0], 
                        "migrated": false,
                        "rpxUrl": "http://rpxnow.com/load/" + parts[0],
                        "s3Url": "http://d16s8pqtk4uodx.cloudfront.net/" + parts[0] + "/load.js"
                    })
                }
            }
...
// mongoClient.open(function(err, mongoClient) {
//     db = mongoClient.db("RPDB");
//     db.collection('RPs', {strict:true}, function(err, collection) {
//         if (err) {
//             console.log("The 'RPs' collection doesn't exist. Creating it with a sample record...");
//             populateDB();
//         }
//     });
// });
...
//     console.log("Populating loadfiles database...");
//     var loadfiles = [
//         {"id": 1, "host": "rpx", "js": "<script type=text/javascript>console.log('I'm stored javascript);</script>"},
//         {"id": 1, "host": "s3", "js": "<script type=text/javascript>console.log('I'm stored javascript, too!);</script>"}
//     ]; 
//     db.collection('loadfiles', function(err, collection) {
//         collection.insert(loadfiles, {safe:true}, function(err, result) {});
//     });
//     console.log('loadfiles collection created'); 
// };
